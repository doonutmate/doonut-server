...
(
    ...
    calender_name     VARCHAR(100)                        NOT NULL COMMENT '캘린더 명',
    total_count       INT                                 NOT NULL COMMENT '총 기록 횟수',
    first_upload_date  TIMESTAMP                               NULL COMMENT '최초 업로드 날짜',
    last_upload_date  TIMESTAMP                               NULL COMMENT '마지막 업로드 날짜',
